...
export const intents = [
  ...
  },
  {
    ...
    responses: [
      "At iTECH-RAR Solutions, Elvin has built modules for Enrollment, Registrar, Finance, Cashier, Student Portal, Teacher Portal, Attendance Monitoring, Peer Evaluation, and Reports. Basically, if a school needs it, he's coded it. Plus 10+ projects with 5+ clients! Latest build: SoleMania — a full-stack shoe e-commerce platform in production (React, Express, MySQL) with size-level stock, cart/wishlist, transaction-safe checkout and an admin dashboard. Code at https://github.com/Vin0210/solemania",
      "His systems are so stable, even his legacy code has job security. Highlights: SoleMania shoe e-commerce in production (storefront, checkout, admin — React, Express, MySQL), Alegre × Good Habits coffee + thrift e-commerce (cart, PayMongo checkout, order tracking, admin — React, Supabase), DentalOS dental clinic system (patients, appointments, dental chart, billing, inventory — React, Laravel, MySQL), enterprise school management systems (enrollment, finance, portals, attendance), interactive React apps, a resort booking platform, DriveRent car rental platform (currently under development), and various client projects."
    ]
  },
  {
    id: 'experience',
